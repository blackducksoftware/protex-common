 ...
 * under the License.
 *******************************************************************************/
package com.blackducksoftware.integration.protex.util;
...
public class TestHelper extends ProtexFacade {
    ...
    public TestHelper(String serverUrl, String username, String password, TestLogger logger) throws InvalidKeyException,
    ...
    public TestHelper(String serverUrl, String username, String password,
            long timeout, TestLogger logger) throws InvalidKeyException,
            NoSuchAlgorithmException, NoSuchPaddingException,
            IllegalBlockSizeException, BadPaddingException, IOException, ServerConfigException {

        super(serverUrl, username, password, timeout);
        super.setLogger(logger);
        this.logger = logger;
    }
    ...
    public TestHelper(String serverUrl, String username, String password,
            long timeout) throws InvalidKeyException,
            NoSuchAlgorithmException, NoSuchPaddingException,
            IllegalBlockSizeException, BadPaddingException, IOException, ServerConfigException {
